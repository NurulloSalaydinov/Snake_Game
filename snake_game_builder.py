...
# i will initialise screen
screen = pygame.display.set_mode((SCREEN_WIDTH,SCREEN_HEIGHT),pygame.HWSURFACE)
# i have used hw surface which stands for hardware surface refers to using memory on the video card for storing
...
background_color = pygame.Color(0,50,230)    # i will fill background color as blue
blue = pygame.Color(100,100,10)
...
# to check the boundaries  here i'm not limiting boundaries like it can pass through screen and come from other side
...
# i will define moves of the snake
    ...
    # now when snake its food it will grow so for that i will add that food to stack
    ...
    def draw(self,screen):
        pygame.draw.rect(screen,pygame.color.Color("orange"), (self.stack[0].x , self.stack[0].y, 
    ...
    for event in pygame.event.get():
        if event.type == pygame.KEYDOWN:
            ...
            # for exit 
                ...
                return "exit"
            # if i want to continue playing again
            elif event.key == pygame.K_y:
                return "yes"
            # if i don't want to play game
...
def main():
    ...
    mySnake.move()
    start_segments = 3   # initially i will be having 3 segment long snake
